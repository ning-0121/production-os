...
export const ACTIONS = {
  ...
  "calibration.trigger":   { risk: "high",   desc: "Trigger recalibration (changes factory scores)" },
  "calibration.complete":  { risk: "high",   desc: "Record order completion (triggers auto-recalibration)" },
  "tasks.generate":        { risk: "medium", desc: "Generate visit tasks (DB write)" },
...
const ROLE_MATRIX = {
  ...
  production_manager: {
    ...
    "tasks.generate": { normal: true, pilot: false },
    "tasks.update": true,
